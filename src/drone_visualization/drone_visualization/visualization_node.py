...
class VisualizationNode(Node):
    ...
    def update_visualization(self):
        ...
        if self.drone_depth is not None:
            depth_pixel = int((self.drone_depth / self.max_depth) * (self.map_height - self.camera_y - 20))
            ...
            cv2.putText(self.map_image, f'Depth: {self.drone_depth:.2f}m', (10, 30),
